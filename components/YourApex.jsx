    ...
    <section className='container pt-[11px] flex flex-col lg:flex lg:flex-row lg:justify-center lg:gap-2 xl:gap-[76px] lg:pr-[60px]' id="create">
      ...
      className="flex flex-col gap-[19px] pt-[32px]">
        ...
        <Link href='/' target="_blank">
              <button className='text-whiten uppercase drop-shadow-lg justify-center lg:text-[26px] xl:text-[36px] lg:leading-[66px] bg-red hover:bg-redh font-integral font-black py-2 px-10 lg:py-0 xl:py-2 lg:px-8 xl:px-16  flex items-center hover:scale-105 transition duration-300 ease-in-out mt-[15px]'>
                  create
              </button>
          </Link>
      </motion.div>
